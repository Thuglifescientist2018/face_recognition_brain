...
class Register extends Component {
  ...
  onSubmitRegister = () => {
    ...
    const {onRouteChange} = this.props
      fetch('https://powerful-depths-32365.herokuapp.com/register', {
        method: "POST",
  ...
  <div className="measurer">
    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
      ...
      <div className="mt3">
        ...
        <input onChange={onNameChange} className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="text" name="email-address"  id="name"/>
      </div>
      <div className="mt3">
